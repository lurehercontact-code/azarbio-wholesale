  ...
  <main id="top">
    ...
    <section class="section soft testimonials-section" id="testimonials">
      <div class="wrap">
        ...
        <p class="proof-note">تم اختصار الرسائل مع الحفاظ على معناها وبالدارجة الأصلية.</p>
      </div>
    </section>
