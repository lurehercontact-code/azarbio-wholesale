  ...
  <main id="top">
    ...
    <section class="section" id="order"><div class="wrap"><div class="formbox">
      ...
      <form id="leadForm" novalidate>
        ...
        <label class="consent"><input type="checkbox" name="consent" value="yes" required><span>أؤكد أن رقم الهاتف هذا يخصني وأنني أرغب فعلاً في هذا الطلب وأوافق على التواصل معي لتأكيده.</span></label>
