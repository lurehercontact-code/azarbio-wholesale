...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{scroll-behavior:smooth;max-width:100%;overflow-x:hidden}
    ...
    .testimonials-section{content-visibility:auto;contain-intrinsic-size:720px}.testimonial-track{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(260px,82vw);gap:12px;overflow-x:auto;padding:2px 2px 14px;scroll-snap-type:x mandatory;overscroll-behavior-inline:contain;scrollbar-width:thin}.testimonial-card{scroll-snap-align:start;background:#fff;border:1px solid var(--line);border-radius:20px;overflow:hidden;box-shadow:var(--shadow);min-width:0}.testimonial-card img{width:100%;aspect-ratio:11/15;object-fit:cover;background:#eef1ef}.testimonial-copy{padding:15px}.testimonial-quote{margin:0;color:#26362d;font-size:14px;font-weight:800;line-height:1.8}.testimonial-meta{display:flex;align-items:center;gap:7px;margin-top:11px;color:var(--green);font-size:11px;font-weight:1000}.testimonial-meta .verified{width:20px;height:20px;border-radius:50%;display:grid;place-items:center;background:var(--green3);flex:0 0 auto}
    ...
    @media(min-width:760px){
      ...
      .fruit-grid{grid-template-columns:repeat(6,1fr)}.opportunity{grid-template-columns:1fr 1fr 1fr}.testimonial-track{grid-auto-flow:row;grid-template-columns:repeat(4,1fr);grid-auto-columns:auto;overflow:visible;padding-bottom:2px}.offers{grid-template-columns:repeat(3,1fr)}.form-grid{grid-template-columns:1fr 1fr}.field.full{grid-column:1/-1}.storage{grid-template-columns:repeat(3,1fr)}
    }
  </style>
</head>
<body>
  <div class="ticker" aria-label="معلومات الجملة والتوصيل">
    <div class="ticker-track">
      <div class="ticker-item"><span>📦 <b>الجملة فقط</b></span><span>الطلب ابتداءً من <b>2.5 كيلو</b></span><span>🚚 التوصيل إلى <b>جميع المدن</b></span></div>
      <div class="ticker-item" aria-hidden="true"><span>📦 <b>الجملة فقط</b></span><span>الطلب ابتداءً من <b>2.5 كيلو</b></span><span>🚚 التوصيل إلى <b>جميع المدن</b></span></div>
      <div class="ticker-item" aria-hidden="true"><span>📦 <b>الجملة فقط</b></span><span>الطلب ابتداءً من <b>2.5 كيلو</b></span><span>🚚 التوصيل إلى <b>جميع المدن</b></span></div>
    </div>
  </div>
  ...
  <main id="top">
    ...
    <section class="section soft testimonials-section" id="testimonials">
      <div class="wrap">
        <div class="section-title"><h2>آراء تجار بعد الاستلام</h2><p>صور حقيقية واقتباسات مختصرة من تجار جرّبوا السلعة وتوصلوا بطلباتهم.</p></div>
        <div class="testimonial-track" aria-label="شهادات التجار">
          <article class="testimonial-card">
            <img src="/testimonial-sachets.svg" width="440" height="600" loading="lazy" decoding="async" alt="أكياس صغيرة من الفواكه المجففة بالتبريد جاهزة للبيع">
            <div class="testimonial-copy"><p class="testimonial-quote">«بديت نعمر الساشيات، داكشي ناضي. الله يسر.»</p><div class="testimonial-meta"><span class="verified">✓</span><span>تجربة تاجر بعد تجهيز الساشيات</span></div></div>
          </article>
          <article class="testimonial-card">
            <img src="/testimonial-shopkeeper.svg" width="440" height="600" loading="lazy" decoding="async" alt="تاجر داخل محله بعد استلام فواكه AzarBio بالجملة">
            <div class="testimonial-copy"><p class="testimonial-quote">«السلعة وصلتني نقية وكاتشهي، الجودة طوب ديال طوب والمذاق ما نعاودش ليك.»</p><div class="testimonial-meta"><span class="verified">✓</span><span>رأي تاجر بعد الاستلام</span></div></div>
          </article>
          <article class="testimonial-card">
            <img src="/testimonial-store.svg" width="440" height="600" loading="lazy" decoding="async" alt="طلبية جملة وصلت إلى محل لبيع المواد الغذائية">
            <div class="testimonial-copy"><p class="testimonial-quote">«التوصيل سريع والسلعة نقية بزاف، وكتزين الحانوت.»</p><div class="testimonial-meta"><span class="verified">✓</span><span>طلبية جملة داخل محل الزبون</span></div></div>
          </article>
          <article class="testimonial-card">
            <img src="/testimonial-thumbs.svg" width="440" height="600" loading="lazy" decoding="async" alt="تاجر راض عن طلبية الفواكه المجففة بالتبريد">
            <div class="testimonial-copy"><p class="testimonial-quote">«تبارك الله عليكم، السلعة نقية ماشي بحال اللي كاين فالسوق.»</p><div class="testimonial-meta"><span class="verified">✓</span><span>انطباع تاجر عن الجودة</span></div></div>
          </article>
        </div>
      </div>
    </section>
